...
class AnalyticsStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamEvents = channel.unary_stream(
                '/analytics.Analytics/StreamEvents',
                request_serializer=analytics__pb2.DateRange.SerializeToString,
...
class AnalyticsServicer(object):
    ...
    def StreamEvents(self, request, context):
        """Метод для получения потока событий за заданный период
        """
...
def add_AnalyticsServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamEvents': grpc.unary_stream_rpc_method_handler(
                    ...
                    request_deserializer=analytics__pb2.DateRange.FromString,
...
class Analytics(object):
    ...
    def StreamEvents(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            target,
            '/analytics.Analytics/StreamEvents',
            analytics__pb2.DateRange.SerializeToString,
